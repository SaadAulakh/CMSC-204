...
public class MyStackTest {
	...
	public void testPopStudent() {
		try {
			assertEquals(Double.valueOf(C), doubleS.pop());
			assertEquals(Double.valueOf(B), doubleS.pop());
			assertEquals(Double.valueOf(A), doubleS.pop());
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		} catch (StackUnderflowException e) {
			assertTrue("This should have caused an StackUnderflowException", true);
	...
	public void testPushStudent() {
		try {
			...
			assertEquals(true, doubleS.push(92.8));
	...
	public void testToStringStudent() {
		assertEquals("1.23.02.9", doubleS.toString());
		doubleS.push(29.1);
		assertEquals("1.23.02.929.1", doubleS.toString());
		doubleS.push(87.2);
		assertEquals("1.23.02.929.187.2", doubleS.toString());
	}
